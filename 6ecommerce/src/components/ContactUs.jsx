...
const ContactUs = () => {
    ...
    return (
        ...
        <>
            <Layout>
                    <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-orange-500 rounded-lg mb-10">
                        <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                            <div>
                                ...
                                <ul class="flex mt-12 space-x-4">
                                    <li class="bg-orange-500 hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            ...
                            <div class="bg-gray-100 p-6 rounded-lg">
                                <p class="text-sm font-semibold text-gray-800">Fill Details....</p>
                                ...
                                <form class="mt-8 space-y-4">
                                    ...
                                    <button type='button'
                                        class="text-white bg-orange-500 hover:bg-[#a91079e2] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
